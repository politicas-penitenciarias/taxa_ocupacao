...
graf1 <-
  ggplot(rel1)+
  geom_point(aes(x = `Capacidade`, y=`População Prisional`, shape = `Unidade Monitoramento`, color = `Tipo de Custódia` ))+
...
setwd("C:/Users/lucas.eneas/OneDrive - MINISTERIO DA JUSTIÇA/analise_dados/taxa_ocupacao/graficos")
